...
##LEDs
#set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { comparison_result }]; #IO_L23P_T3_35 Sch=led[0]
set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS33} [get_ports comparison_result]
...
connect_debug_port u_ila_0/probe1 [get_nets [list comparison_result_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA [get_debug_ports u_ila_0/probe2]
set_property port_width 1 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list enable_IBUF]]
create_debug_port u_ila_0 probe
