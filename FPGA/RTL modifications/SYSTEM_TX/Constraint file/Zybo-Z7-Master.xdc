...
set_property -dict {PACKAGE_PIN P15 IOSTANDARD LVCMOS33} [get_ports { dds_enable }]
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { real_match_flag }]; #IO_L23P_T3_35 Sch=led[0]
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { imag_match_flag }]; #IO_L23N_T3_35 Sch=led[1]
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { tx_valid }]; #IO_0_35 Sch=led[2]
