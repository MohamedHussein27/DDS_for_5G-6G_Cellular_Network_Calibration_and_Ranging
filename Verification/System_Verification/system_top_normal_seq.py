...
class normal_Seq(uvm_sequence):
    """
    Normal Sweep Sequence.
    Applies a sweeping chirp (f0 = 0 MHz, B = 200 MHz).
    The OFDM memory is left uninitialized.
    """
    def __init__(self, name="normal_seq"):
        super().__init__(name)
        self.num_frames = 1  
