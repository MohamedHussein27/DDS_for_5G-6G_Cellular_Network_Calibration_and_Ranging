...
def fi_cast(x, WL, FL):
    ...
    return quantize_fixed(x, WL=WL, FL=FL, signed=True, rounding='convergent', overflow='saturate')
...
def run_tx_top_pipeline(
    ...
    X_combined_float = X_combined_int / (2**FL_FFT)
    X_combined_fi = fi_cast(X_combined_int, WL=16, FL=8)
