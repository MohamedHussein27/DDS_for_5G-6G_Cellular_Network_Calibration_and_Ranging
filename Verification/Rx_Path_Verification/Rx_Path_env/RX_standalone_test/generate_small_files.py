...
# ─────────────────────────────────────────────────────────────────────────────
# Constants from mixed_ofdm_radar_small_seq
# ─────────────────────────────────────────────────────────────────────────────
WL           = 16
FL           = 8
N_FFT        = 4096
...
if __name__ == "__main__":
    print("Generating Micro-Signal Sequence Files...")
    
    # Generate data using the exact same seed (0) as your testbench
    rx_samples  = _build_mixed_rx_frame_small(seed=0)
    ref_samples = _build_chirp_reference_small(seed=0)
    ...
    print("\nSuccess! Files are ready for the Verilog Testbench.")