...
module TX_TOP #(
    ...
    // NEW: Bit-Reversal Outputs (for debug / reuse)
    ...
    isac_mux #(.WL(WL), .N(N)) u_mux (
        ...
        .radar_in_re(bit_rev_re >>> 7),
        .radar_in_im(bit_rev_im >>> 7),
    ...
    // =======================================================
    // NEW: Direct Output Assignment (NO LOGIC CHANGE)
    // =======================================================
