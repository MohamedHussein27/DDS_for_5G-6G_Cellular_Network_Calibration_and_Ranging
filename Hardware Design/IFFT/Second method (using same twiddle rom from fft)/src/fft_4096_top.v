module fft_4096_top #(
    ...
    // Stage 1 (Delay = 2048)
    fft_stage #(.WL(WL), .DELAY_LEN(2048), .ROM_DEPTH(2048), 
                .FILE_REAL("twiddlerom/twiddle_stage_1_real.mem"), .FILE_IMAG("twiddlerom/twiddle_stage_1_imag.mem")) stg1 (
        .clk(clk), .rst_n(rst_n),
    ...
    // Stage 2 (Delay = 1024)
    fft_stage #(.WL(WL), .DELAY_LEN(1024), .ROM_DEPTH(1024), 
                .FILE_REAL("twiddlerom/twiddle_stage_2_real.mem"), .FILE_IMAG("twiddlerom/twiddle_stage_2_imag.mem")) stg2 (
        .clk(clk), .rst_n(rst_n),
    ...
    // Stage 3 (Delay = 512)
    fft_stage #(.WL(WL), .DELAY_LEN(512), .ROM_DEPTH(512), 
                .FILE_REAL("twiddlerom/twiddle_stage_3_real.mem"), .FILE_IMAG("twiddlerom/twiddle_stage_3_imag.mem")) stg3 (
        .clk(clk), .rst_n(rst_n),
    ...
    // Stage 4 (Delay = 256)
    fft_stage #(.WL(WL), .DELAY_LEN(256), .ROM_DEPTH(256), 
                .FILE_REAL("twiddlerom/twiddle_stage_4_real.mem"), .FILE_IMAG("twiddlerom/twiddle_stage_4_imag.mem")) stg4 (
        .clk(clk), .rst_n(rst_n),
    ...
    // Stage 5 (Delay = 128)
    fft_stage #(.WL(WL), .DELAY_LEN(128), .ROM_DEPTH(128), 
                .FILE_REAL("twiddlerom/twiddle_stage_5_real.mem"), .FILE_IMAG("twiddlerom/twiddle_stage_5_imag.mem")) stg5 (
        .clk(clk), .rst_n(rst_n),
    ...
    // Stage 6 (Delay = 64)
    fft_stage #(.WL(WL), .DELAY_LEN(64), .ROM_DEPTH(64), 
                .FILE_REAL("twiddlerom/twiddle_stage_6_real.mem"), .FILE_IMAG("twiddlerom/twiddle_stage_6_imag.mem")) stg6 (
        .clk(clk), .rst_n(rst_n),
    ...
    // Stage 7 (Delay = 32)
    fft_stage #(.WL(WL), .DELAY_LEN(32), .ROM_DEPTH(32), 
                .FILE_REAL("twiddlerom/twiddle_stage_7_real.mem"), .FILE_IMAG("twiddlerom/twiddle_stage_7_imag.mem")) stg7 (
        .clk(clk), .rst_n(rst_n),
    ...
    // Stage 8 (Delay = 16)
    fft_stage #(.WL(WL), .DELAY_LEN(16), .ROM_DEPTH(16), 
                .FILE_REAL("twiddlerom/twiddle_stage_8_real.mem"), .FILE_IMAG("twiddlerom/twiddle_stage_8_imag.mem")) stg8 (
        .clk(clk), .rst_n(rst_n),
    ...
    // Stage 9 (Delay = 8)
    fft_stage #(.WL(WL), .DELAY_LEN(8), .ROM_DEPTH(8), 
                .FILE_REAL("twiddlerom/twiddle_stage_9_real.mem"), .FILE_IMAG("twiddlerom/twiddle_stage_9_imag.mem")) stg9 (
        .clk(clk), .rst_n(rst_n),
    ...
    // Stage 10 (Delay = 4)
    fft_stage #(.WL(WL), .DELAY_LEN(4), .ROM_DEPTH(4), 
                .FILE_REAL("twiddlerom/twiddle_stage_10_real.mem"), .FILE_IMAG("twiddlerom/twiddle_stage_10_imag.mem")) stg10 (
        .clk(clk), .rst_n(rst_n),
    ...
    // Stage 11 (Delay = 2)
    fft_stage #(.WL(WL), .DELAY_LEN(2), .ROM_DEPTH(2), 
                .FILE_REAL("twiddlerom/twiddle_stage_11_real.mem"), .FILE_IMAG("twiddlerom/twiddle_stage_11_imag.mem")) stg11 (
        .clk(clk), .rst_n(rst_n),
    ...
    // You can either pass a 1-depth ROM filled with '1', or bypass the multiplier in this specific stage later.
    fft_stage #(.WL(WL), .DELAY_LEN(1), .ROM_DEPTH(1), 
                .FILE_REAL("twiddlerom/twiddle_stage_12_real.mem"), .FILE_IMAG("twiddlerom/twiddle_stage_12_imag.mem")) stg12 (
        .clk(clk), .rst_n(rst_n),
